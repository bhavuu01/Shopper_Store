      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildParagraph(
              'Welcome to [Shopper Store]! This privacy policy explains how [Shopper Store] collects, uses, and protects your personal information when you use our mobile application [Shopper Store] (referred to as the "Service"). By using the Service, you agree to the collection and use of information in accordance with this policy.',
            ),
            const SizedBox(height: 20.0),
